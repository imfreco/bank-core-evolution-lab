package com.imfreco.bank_core_evolution_lab.account.infrastructure.adapter.out.persistence;
...
public interface AccountRepository extends JpaRepository<Account, UUID>, AccountRepositoryPort {
    ...
    @Query(
            "select a from Account a where a.accountNumber in :accountNumbers order by a.accountNumber asc")
    List<Account> findAllByAccountNumberInForUpdate(
